...
#This code has been dveloped by SAREEL to develop the Philippines' 
#new transmsion grid.
...
store_1 = pp.create_storage(net, Zone1Bus, p_mw=17*1000, max_e_mwh=100*1000, min_e_mwh=5.0*1000, name="Storage_1")
store_2 = pp.create_storage(net, Zone2Bus, p_mw=15*1000, max_e_mwh=90*1000, min_e_mwh=5.0*1000, name="Storage_2")
store_7 = pp.create_storage(net, Zone7Bus, p_mw=20*1000, max_e_mwh=120*1000, min_e_mwh=5.0*1000, name="Storage_7")
store_8 = pp.create_storage(net, Zone8Bus, p_mw=10*1000, max_e_mwh=60*1000, min_e_mwh=5.0*1000, name="Storage_8")
...
L8_Length=220
pp.create_line_from_parameters(net,from_bus=Zone2Bus, to_bus=Region3Bus ,length_km=L8_Length, r_ohm_per_km =R_230, x_ohm_per_km =X_230,c_nf_per_km =C_230, max_i_ka=Max_230,name = "L8")
L9_Length=70
...
L8b_Length=220
pp.create_line_from_parameters(net,from_bus=Zone2Bus, to_bus=Region3Bus ,length_km=L8_Length, r_ohm_per_km =R_230, x_ohm_per_km =X_230,c_nf_per_km =C_230, max_i_ka=Max_230,name = "L8a")
L9b_Length=70
...
L22_Length=160
pp.create_line_from_parameters(net,from_bus=Region7Bus, to_bus=Region8Bus  ,length_km=L22_Length, r_ohm_per_km =R_230, x_ohm_per_km =X_230,c_nf_per_km =C_230, max_i_ka=Max_230,name = "L22")
L23_Length=170
...
L31_Length=400
pp.create_line_from_parameters(net,from_bus=Zone3Bus, to_bus=Zone2Bus  ,length_km=L31_Length, r_ohm_per_km =R_230, x_ohm_per_km =X_230,c_nf_per_km =C_230, max_i_ka=Max_230,name = "L31")


L32_Length=140
pp.create_line_from_parameters(net,from_bus=Mindanao3Bus, to_bus=Region7Bus  ,length_km=L31_Length, r_ohm_per_km =R_230, x_ohm_per_km =X_230,c_nf_per_km =C_230, max_i_ka=Max_230,name = "L32")
